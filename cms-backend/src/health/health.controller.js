...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(health) {
    ...
    (function () {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, terminus_1.HealthCheck)(), (0, swagger_1.ApiResponse)({ status: 200, description: 'Server healthy' })];
